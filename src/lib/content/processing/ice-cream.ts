            ...
            iceCream: {
                ...
                content: `
                    ...
                    <ol class="list-decimal list-outside pl-5 space-y-4">
                        ...
                        <li><strong>Homogenization (oPRP):</strong> The hot mix is homogenized at high pressure to break down fat globules into very small, uniform sizes (<1 micron). This is a critical <strong>oPRP</strong> that prevents the fat from separating out (creaming) and contributes to a smoother texture and richer mouthfeel. It achieves this by creating a new, larger surface area for the fat, which is then coated by proteins (casein and whey), creating a stable emulsion.</li>
                        ...
                        <li><strong>Flavor & Color Addition:</strong> After aging, the desired liquid flavors and colors are added to the mix just before it enters the freezer. This ensures the flavors are fresh and not degraded by the pasteurization heat.</li>
                ...
                content: `
                    ...
                    <p>The processing of frozen dessert is nearly identical to that of ice cream. The key difference lies in the initial blending stage, where vegetable fat is used instead of milk fat.</p>
                     <ol class="list-decimal list-outside pl-5 space-y-4">
                        ...
                        <li><strong>Homogenization (oPRP):</strong> This step is an <strong>oPRP</strong> that creates a stable emulsion between the vegetable fat and the aqueous phase.</li>
            ...
            iceCream: {
                ...
                content: `
                    ...
                    <ol class="list-decimal list-outside pl-5 space-y-4">
                        ...
                        <li><strong>समरूपता (oPRP):</strong> गर्म मिश्रण को उच्च दबाव पर समरूप किया जाता है ताकि वसा के ग्लोब्यूल्स को बहुत छोटे, समान आकार (<1 माइक्रोन) में तोड़ा जा सके। यह एक महत्वपूर्ण <strong>oPRP</strong> है जो वसा के पृथक्करण (क्रीमिंग) को रोकता है और एक चिकनी बनावट और समृद्ध माउथफिल में योगदान देता है। यह वसा के लिए एक नया, बड़ा सतह क्षेत्र बनाकर इसे प्राप्त करता है, जो तब प्रोटीन (कैसिइन और मट्ठा) द्वारा लेपित होता है, एक स्थिर पायस बनाता है।</li>
                ...
                content: `
                    ...
                    <p>फ्रोजन डेजर्ट की प्रसंस्करण आइसक्रीम के लगभग समान है। मुख्य अंतर प्रारंभिक मिश्रण चरण में है, जहाँ दूध की वसा के बजाय वनस्पति वसा का उपयोग किया जाता है।</p>
                     <ol class="list-decimal list-outside pl-5 space-y-4">
                        ...
                        <li><strong>समरूपता (oPRP):</strong> यह कदम एक <strong>oPRP</strong> है जो वनस्पति वसा और जलीय चरण के बीच एक स्थिर पायस बनाता है।</li>
