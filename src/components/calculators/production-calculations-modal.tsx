...
const ShiftReportCalc = dynamic(() => import("./shift-report-calc"), { ssr: false, loading: () => <div className="flex items-center justify-center p-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div> });
...
const calculatorsInfo = {
    "shift-report": {
      ...
      component: ShiftReportCalc,
      color: "from-teal-500 to-emerald-600", // ✅ Gradient Teal
    },
    yields: {
