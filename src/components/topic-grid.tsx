...
const topics: { id: string; title: string; description: string; category: string; icon: React.ElementType; badge?: string; modal: React.ElementType; isPro: boolean; color: string; }[] = [
  ...
  { id: 'adulteration', title: 'Adulteration', description: 'Detection & Prevention', category: 'quality', icon: TestTube, badge: 'Updated', modal: AdulterationModal, isPro: false, color: 'from-yellow-100 to-amber-200' },
  ...
  { id: 'production-calculations', title: 'Production Calculations', description: 'Batch & Yield Calculations', category: 'process', icon: Combine, modal: ProductionCalculationsModal, isPro: true, color: 'from-violet-100 to-purple-200' },
