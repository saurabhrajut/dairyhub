...
const topics = [
    { value: "introduction", title: "Introduction", icon: BookOpen, component: topicComponents.introduction },
    { value: "reception", title: "Reception", icon: Droplet, component: topicComponents.reception },
    { value: "transportation", title: "Transport", icon: Truck, component: topicComponents.transportation },
    { value: "storage", title: "Storage", icon: Warehouse, component: topicComponents.storage },
    { value: "preservation", title: "Preservation", icon: Shield, component: topicComponents.preservation },
    { value: "conclusions", title: "Conclusions", icon: CheckCircle, component: topicComponents.conclusions },
];
      ...
      <DialogContent className="max-w-5xl h-[90vh] flex flex-col p-0 sm:p-6">
        <DialogHeader className="p-4 sm:p-0 shrink-0">
          ...
          <DialogDescription className="text-center text-lg text-gray-500">
            {selectedTopic ? selectedTopic.title : "From Reception to Preservation: Ensuring Quality and Safety"}
          </DialogDescription>
        </DialogHeader>
