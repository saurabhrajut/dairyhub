...
const processingTopics = [
    { value: "workflow", title: "Workflow & Digitalization", icon: Settings, content: <WorkflowContent /> },
    { value: "reception", title: "Reception & Purification", icon: Truck, content: <ReceptionContent /> },
    { value: "centrifugal", title: "Centrifugal & Physical Control", icon: RotateCw, content: <CentrifugalContent /> },
    { value: "thermal", title: "Thermal Processing Principles", icon: Thermometer, content: <ThermalPrinciplesContent /> },
    { value: "packaging", title: "Downstream & Packaging", icon: ShieldCheck, content: <PackagingContent /> },
];
...
function WorkflowContent() {
    return (
        <Section title="The Integrated Dairy Processing Workflow" icon={Settings}>
            <h4>From Linear Chain to Digital Ecosystem</h4>
            ...
            <h4>The Macro-Level Process Flow</h4>
            ...
            <h4>The Paradigm Shift to Automation and Digitalization</h4>
            ...
            <h4>Data as a Critical Ingredient: The Digital Enterprise</h4>
            ...
            <h4>Core Functional and Non-Functional Requirements</h4>
...
function ReceptionContent() {
    return (
        <Section title="Raw Milk Reception and Preliminary Purification" icon={Truck}>
            ...
            <h4>Raw Milk Reception: The First Line of Quality Defense</h4>
            ...
            <h5>Unloading and Initial Checks</h5>
            ...
            <h5>Critical Acceptance Tests</h5>
            ...
            <h4>Chilling and Raw Milk Storage</h4>
            ...
            <h4>Filtration and Clarification: A Two-Stage Purification Process</h4>
            ...
            <h5>Comparative Effectiveness and Limitations</h5>
...
function CentrifugalContent() {
    return (
        <Section title="Centrifugal Processing and Compositional & Physical Control" icon={RotateCw}>
            ...
            <h4>Cream Separation: Deconstructing Milk into its Core Components</h4>
            ...
            <h4>Standardization: Engineering the Final Product Composition</h4>
            ...
            <h4>Homogenization: Creating a Stable Emulsion</h4>
            ...
            <h5>Two-Stage Homogenization</h5>
            ...
            <h4>Bactofugation: Advanced Microbial Reduction</h4>
            ...
            <h5>Efficiency and Applications</h5>
...
function ThermalPrinciplesContent() {
    return (
        <Section title="Thermal Processing: The Cornerstone of Dairy Safety and Stability" icon={Thermometer}>
            ...
            <h4>Principles of Thermal Microbiology and Inactivation Kinetics</h4>
            ...
            <h4>Kinetic Parameters: The Language of Thermal Processing</h4>
            ...
            <h5>Decimal Reduction Time (D-value)</h5>
            ...
            <h5>Thermal Resistance Constant (Z-value)</h5>
            ...
            <h5>Thermal Death Time (F-value or Lethality)</h5>
            ...
            <h4>Pasteurization: Ensuring Public Health</h4>
            ...
            <h5>High-Temperature, Short-Time (HTST) Pasteurization</h5>
            ...
            <h4>Heat Exchanger Technology: The Engine of Thermal Processing</h4>
            ...
            <h5>Plate Heat Exchangers (PHEs)</h5>
            ...
            <h4>Vacreation: Combined Pasteurization and Deodorization</h4>
            ...
            <h4>Sterilization and Ultra-High Temperature (UHT) Processing: Creating Shelf-Stability</h4>
            ...
            <ul>
             ...
             <h5>Nutritional and Sensory Impact</h5>
            ...
            <h4>Post-Treatment Cooling: Locking in Quality</h4>
...
function PackagingContent() {
    return (
        <Section title="Downstream Operations and Advanced Packaging" icon={ShieldCheck}>
            ...
            <h4>Fermentation Science: Creating Cultured Dairy Products</h4>
            ...
            <h4>Aseptic Packaging Technology: The Key to Shelf-Stability</h4>
            ...
            <h4>Quality Assurance and Process Modernization</h4>
            ...
            <h5>Integrated Quality Control Systems (QCS): A Holistic Approach</h5>
            ...
            <h5>Regulatory Framework and Industry Standards</h5>
            ...
            <h5>The Role of Automation in Modern Quality Assurance</h5>
            ...
            <h4>Conclusion: A Synthesis of an Interdependent System</h4>
