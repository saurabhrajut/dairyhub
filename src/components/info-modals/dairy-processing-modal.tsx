    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-6xl h-[90vh] flex flex-col">
        <DialogHeader>
         ...
         <Tabs defaultValue="workflow" orientation="vertical" className="w-full flex-1 flex flex-col md:flex-row min-h-0">
            <ScrollArea className="flex-shrink-0 md:pr-4 -ml-4 pl-4 md:pl-0">
                <TabsList className="grid w-full h-auto md:w-56">
                    <TabsTrigger value="workflow" className="text-left justify-start">Workflow Overview</TabsTrigger>
                    <TabsTrigger value="filtration" className="text-left justify-start">Filtration & Clarification</TabsTrigger>
                    <TabsTrigger value="separation" className="text-left justify-start">Cream Separation</TabsTrigger>
                    <TabsTrigger value="standardization" className="text-left justify-start">Standardization</TabsTrigger>
                    <TabsTrigger value="homogenization" className="text-left justify-start">Homogenization</TabsTrigger>
                    <TabsTrigger value="bactofugation" className="text-left justify-start">Bactofugation</TabsTrigger>
                    <TabsTrigger value="heat-treatment" className="text-left justify-start">Heat Treatment</TabsTrigger>
                    <TabsTrigger value="kinetics" className="text-left justify-start">Kinetic Parameters</TabsTrigger>
                    <TabsTrigger value="pasteurization" className="text-left justify-start">Pasteurization</TabsTrigger>
                    <TabsTrigger value="htst-operation" className="text-left justify-start">HTST Operation</TabsTrigger>
                    <TabsTrigger value="heat-exchangers" className="text-left justify-start">Heat Exchangers</TabsTrigger>
                    <TabsTrigger value="vacuum-pasteurization" className="text-left justify-start">Vacreation</TabsTrigger>
                    <TabsTrigger value="sterilization" className="text-left justify-start">Sterilization/UHT</TabsTrigger>
                </TabsList>
            </ScrollArea>
