...
const processingTopics = [
    { value: "workflow", title: "Workflow Overview", icon: Settings, content: <WorkflowContent /> },
    { value: "filtration", title: "Filtration & Clarification", icon: Filter, content: <FiltrationContent /> },
    { value: "separation", title: "Cream Separation", icon: Droplet, content: <SeparationContent /> },
    { value: "standardization", title: "Standardization", icon: Scaling, content: <StandardizationContent /> },
    { value: "homogenization", title: "Homogenization", icon: Layers, content: <HomogenizationContent /> },
    { value: "bactofugation", title: "Bactofugation", icon: RotateCw, content: <BactofugationContent /> },
    { value: "heat-treatment", title: "Heat Treatment", icon: Thermometer, content: <HeatTreatmentContent /> },
    { value: "kinetics", title: "Kinetic Parameters", icon: Clock, content: <KineticsContent /> },
    { value: "pasteurization", title: "Pasteurization", icon: Zap, content: <PasteurizationContent /> },
    { value: "htst-operation", title: "HTST Operation", icon: Power, content: <HtstOperationContent /> },
    { value: "heat-exchangers", title: "Heat Exchangers", icon: View, content: <HeatExchangersContent /> },
    { value: "vacuum-pasteurization", title: "Vacreation", icon: Wind, content: <VacreationContent /> },
    { value: "sterilization", title: "Sterilization/UHT", icon: ShieldCheck, content: <SterilizationContent /> }
];
...
function HomogenizationContent() {
    return (
...
function HeatExchangersContent() {
    return (
