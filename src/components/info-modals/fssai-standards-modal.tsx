...
const fssaiTabs = [
    ...
    { value: "fat-products", label: "Fat Products" },
    { value: "butter", label: "Butter" },
    { value: "milk-powders", label: "Milk Powders" },
    { value: "fermented", label: "Fermented" },
    { value: "ice-cream", label: "Ice Cream" },
    { value: "chhana-paneer", label: "Paneer" },
    { value: "cheese", label: "Cheese" },
    { value: "casein", label: "Casein" },
    { value: "lactose", label: "Lactose" },
    { value: "whey-protein", label: "Whey Protein" },
    { value: "colostrum", label: "Colostrum" },
];
      ...
      <DialogContent className="max-w-4xl lg:max-w-6xl w-[95vw] h-full max-h-[90vh] flex flex-col p-0 sm:p-6">
        ...
        <Tabs defaultValue="general" className="w-full flex-1 flex flex-col min-h-0">
            <ScrollArea className="flex-shrink-0">
                <TabsList className="grid w-full h-auto grid-cols-3 md:grid-cols-5 lg:grid-cols-8 p-2 sm:p-0">
                   {fssaiTabs.map((tab) => (
            ...
            <ScrollArea className="flex-1 mt-4 sm:pr-4">
                 <div className="p-4 sm:p-0 prose prose-sm max-w-none text-gray-700 leading-relaxed break-words">
                   ...
                   <TabsContent value="khoa" className="mt-0">
                   ...
                   <TabsContent value="cream" className="mt-0">
                   ...
                   <TabsContent value="fat-products" className="mt-0">
                   ...
                   <TabsContent value="milk-powders" className="mt-0">
                   ...
                   <TabsContent value="fermented" className="mt-0">
                   ...
                   <TabsContent value="chhana-paneer" className="mt-0">
                   ...
                   <TabsContent value="casein" className="mt-0">
                   ...
                   <TabsContent value="whey-protein" className="mt-0">
                   ...
                   <TabsContent value="colostrum" className="mt-0">
