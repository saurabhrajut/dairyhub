...
export default function Home() {
  ...
  useEffect(() => {
    // Check if query param specifies tab
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-background to-blue-50 pb-16">
      <AnimatedBackground />
      <div className="max-w-7xl mx-auto p-4 sm:p-6 relative z-10">
        ...
        <main>
          ...
          <div className="text-center my-6 cursor-pointer" onClick={handleBounce}>
            ...
            <p className={cn(
                "font-headline text-xs sm:text-sm font-semibold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent"
              )} style={{ animationDelay: '0.4s' }}>
              By Saurabh Rajput
            </p>
          </div>

          <TopicGrid activeTab={activeTab} />
        </main>
        
        {/* Footer with Links */}
        <footer className="w-full py-6 mt-6 border-t border-gray-200/50 text-center z-20 relative mb-12">
